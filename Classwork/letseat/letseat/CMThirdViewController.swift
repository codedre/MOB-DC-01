...
class CMThirdViewController: UIViewController {

    var wrapper: UIView?
    var delegate: FoodOptions?
    ...
    func drawOptions() {
        ...
        self.firstOpt.setTitle("SPICY", forState: .Normal)
        ...
        self.secondOpt.setTitle("SWEET", forState: .Normal)
        ...
        self.thirdOpt.setTitle("HEALTHY", forState: .Normal)
        ...
        self.fourthOpt.setTitle("ETHNIC", forState: .Normal)
        ...
        self.fifthOpt.setTitle("CRUNCHY", forState: .Normal)
        ...
        self.sixthOpt.setTitle("DEEP FRIED", forState: .Normal)
        ...
        self.seventhOpt.setTitle("COLD", forState: .Normal)
    ...
    func getOption(sender:UIButton){
        ...
        case 1:
            ...
            self.delegate?.selectedFood(option!)
