...
class FourthViewController: UIViewController {
    ...
    @IBOutlet weak var fibonacciIndexNumberField: UITextField!
    @IBOutlet weak var printsXthFibonacciNumberToLabel: UILabel!
/*
...
*/
    ...
    @IBAction func caluclateFibonacciNumberButton(sender: AnyObject) {
        if let fibNum = fibonacciIndexNumberField.text.toInt(){
            var answer = FibonacciAdder()
            
            printsXthFibonacciNumberToLabel.text = "\(answer.fibonacciNumberAtIndex(fibNum))"
        }
    }
